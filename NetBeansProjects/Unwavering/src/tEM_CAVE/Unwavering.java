...
public class Unwavering extends BasicGameState {
	...
	public ArrayList<Itemwin> stuffwin = new ArrayList();
        ...
        public ArrayList<Dog> kennel = new ArrayList();
	...
	throws SlickException {
		...
		grassMap = new TiledMap("res/Simon_7_gamemap1.tmx");
...
//		stuff.add(healthpotion1);
                ...
                annoying = new Dog(765,1460);
                kennel.add(annoying);
                
                annoying = new Dog(1176,1321);
                kennel.add(annoying);
                
                annoying = new Dog(1428,481);
                kennel.add(annoying);
                
                annoying = new Dog(1150,795);
                kennel.add(annoying);
                
                annoying = new Dog(1809,1827);
                kennel.add(annoying);
                
                annoying = new Dog(2802,534);
                kennel.add(annoying);
                
                annoying = new Dog(1749,660);
                kennel.add(annoying);
                
                annoying = new Dog(1633,1018);
                kennel.add(annoying);
                
//                flava = new Enemy(300, 300);
//                flay = new Enemy(256, 256);
//                bonez.add(flava);
//                bonez.add(flay);
